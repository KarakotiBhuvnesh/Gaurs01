...
const LeadForm = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // TODO: add your actual submit logic (API call, etc.)
  ...
  return (
    <section className="relative bg-gradient-to-br from-orange-50 via-red-50 to-orange-50 py-20 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        {/* Main CTA Card */}
        <div
          className={`bg-white rounded-3xl shadow-2xl overflow-hidden transition-filter duration-300 ${
            showThankYou ? "backdrop-blur-sm pointer-events-none" : ""
          }`}
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="bg-gradient-to-br from-orange-600 via-red-600 to-orange-700 p-10 lg:p-12 text-white">
              ...
              <p className="text-lg text-white/90 mb-6 leading-relaxed">
                Only a few units left! Lock in your investment at ₹1 Cr entry
                point before prices rise with Jewar Airport&apos;s completion.
              </p>
            ...
            <section
              id="lead-form"
              className="py-12 px-4 bg-gray-900 text-white relative"
            >
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full bg-red-600 py-3 rounded font-semibold hover:bg-red-700 transition-colors"
                >
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-3 bg-white rounded-full px-6 py-3 shadow-lg">
            ...
            <span className="text-sm font-semibold text-gray-800">
              <span className="text-red-600">12 people</span> are viewing this
              property right now
            </span>
          </div>
        </div>
...
{showThankYou && (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
    <div className="relative w-[90vw] max-w-3xl h-[60vh] max-h-[70vh] mx-4 rounded-2xl shadow-2xl overflow-hidden">
      {/* Background image */}
      <div
      ...
      {/* Soothing dark overlay */}
      <div className="absolute inset-0 bg-black/50" />

      {/* Content */}
      <div className="relative h-full flex flex-col p-8 text-center text-white">
        <button
          type="button"
          onClick={handleClose}
        ...
        <div className="flex-1 flex flex-col justify-center px-4 overflow-y-auto">
          ...
          <p className="text-sm md:text-base text-gray-100 mb-4">
            Our team will contact you shortly with pricing, brochure, and site
            visit details. You can close this message now or it will disappear
            automatically in 10 seconds.
          </p>
          <p className="text-xs text-gray-200">
            Meanwhile, explore more about Gaur Yamuna City studio apartments
            below.
          </p>
        </div>
        ...
        <div className="mt-4 flex justify-center">
          <button
            type="button"
            onClick={handleClose}
            className="inline-flex justify-center px-8 py-2.5 rounded-full bg-red-600 text-white text-sm font-semibold hover:bg-red-700 transition-colors"
          >
            Close
          </button>
        </div>
